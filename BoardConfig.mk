...
BOARD_KERNEL_CMDLINE := androidboot.hardware=bacon androidboot.bootdevice=msm_sdcc.1 ehci-hcd.park=3 androidboot.selinux=permissive
...
# SELinux
include $(PLATFORM_PATH)/sepolicy/sepolicy.mk
